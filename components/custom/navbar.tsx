    ...
    <AnimatePresence>
      {isVisible && (
        <motion.nav
          ...
          className="fixed w-full top-0 left-0 bg-blend-color-dodge z-50 bg-yellow-500/50 backdrop-blur-md"
        >
          <div className="max-w-full flex justify-between items-center py-2 px-4 sm:px-6 lg:px-12">
            <div className="flex items-center gap-2 md:p-2">
               <Image
                ...
                priority
              />
              <p className="text-[20px] md:text-[35px] font-extrabold text-slate-900 tracking-tighter">
                OneSystem
              </p>
            </div>
            ...
            <div className="hidden md:flex w-full justify-end items-center h-16 gap-4 md:gap-8">
              {menuItems.map((item) => (
                <button
                  ...
                  className="text-slate-900 hover:underline decoration-yellow-500 px-3 py-2 rounded-md text-[20px] md:text-[20px] font-extrabold transition-colors focus:outline-none"
